                ...
                <div class="card">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="text-c-yellow f-w-600">{{\App\Models\Saloon::where('status', 1)->count()}}</h4>
            ...
            <div class="col-xl-3 col-md-6">
                <div class="card">
                    <div class="card-block">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h4 class="text-c-green f-w-600">{{\App\Models\User::where('role_type', 'customer')->count()}}</h4>
